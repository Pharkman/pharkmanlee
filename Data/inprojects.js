      ...
      return `
        <section class="project-container">
          <section class="project-image">
            ...
            <a class="link-to" href="${works.projectlink}" target="_blank">
      ...
      return `
        <section class="project-container">
          <section class="project-image">
            ...
            <a class="link-to" href="javascript:void(0)" onclick="showPasswordModal(${works.id})">
              <section class="project-hover">
      ...
      return `
        <section class="project-container">
          <section class="project-image">
            ...
            <a class="link-to" href="display.html?id=${works.id}">
              <section class="project-hover">
                <span class="material-icons">north_east</span>
              </section>
            </a>
