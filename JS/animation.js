document.addEventListener('DOMContentLoaded', () => {
            ...
            sr.reveal('.lets-work h1', { delay: 300, origin: 'left', distance: '50px' });
            sr.reveal('.lets-work p', { delay: 500, origin: 'right', distance: '50px' });
        });